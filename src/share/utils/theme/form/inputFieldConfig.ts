...
export function createInputFieldStyleVars(config: InputFieldStyleConfig | undefined): string | undefined {
  ...
  const entries = [
    ...
    ['--input-field-wrapper-invalid-ring-color', config.wrapper?.invalidRingColor],
    ['--input-field-wrapper-valid-border-color', config.wrapper?.validBorderColor],
    ['--input-field-wrapper-valid-ring-color', config.wrapper?.validRingColor],
