...
applyTo: '**/.agents/skills/**/SKILL.md, **/.github/skills/**/SKILL.md'
---
...
| -------------------------------- | -------------------- | ------------------------------- |
| `.agents/skills/<skill-name>/`   | Project/repository   | Recommended for project skills  |
| `.github/skills/<skill-name>/`   | Project/repository   | Backward compatibility          |
| `~/.agents/skills/<skill-name>/` | Personal (user-wide) | Recommended for personal skills |
| `~/.github/skills/<skill-name>/` | Personal (user-wide) | Backward compatibility          |
